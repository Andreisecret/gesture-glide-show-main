  ...
  head: () => ({
    meta: [
      { title: "Help — GestureDeck gesture cheat sheet" },
      {
        name: "description",
        content:
          "Gesture cheat sheet, keyboard shortcuts, and presenter tips for navigating slides with hand gestures in GestureDeck.",
      },
      { property: "og:title", content: "Help — GestureDeck gesture cheat sheet" },
      {
        property: "og:description",
        content: "Gesture cheat sheet, keyboard shortcuts, and presenter tips for GestureDeck.",
      },
      { property: "og:url", content: "https://gesture-glide-show.lovable.app/help" },
    ],
    links: [{ rel: "canonical", href: "https://gesture-glide-show.lovable.app/help" }],
    scripts: [
      {
          ...
          mainEntity: [
            {
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Swipe your hand quickly to the right in front of the webcam, or press the right arrow key.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Swipe your hand quickly to the left, or press the left arrow key.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Make a closed fist gesture, or press B on the keyboard.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Extend only your index finger. The pointer follows your fingertip on screen.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "No. All gesture detection runs locally in your browser via MediaPipe — nothing is uploaded.",
              },
            },
          ],
        }),
    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-3xl px-6 py-12">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Rebind anything on the{" "}
          <a href="/settings" className="text-primary underline-offset-2 hover:underline">
            Settings
          </a>{" "}
          page. Keyboard shortcuts work everywhere: <span className="font-mono">←/→</span> navigate,{" "}
          <span className="font-mono">B</span> blank, <span className="font-mono">F</span>{" "}
          fullscreen, <span className="font-mono">Esc</span> exit.
        </p>
        ...
        <section className="mt-10 space-y-3 text-sm text-muted-foreground">
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>
              <span className="font-mono">PDF</span> — drop it on the home page. Rendered fully
              in-browser.
            </li>
            <li>
            ...
            <li>
              ...
              Convert to PDF first (PowerPoint Online → Export, CloudConvert), or upload to Google
              Slides and open it from there.
            </li>
          </ul>
        </section>
        ...
        <section className="mt-10 space-y-3 text-sm text-muted-foreground">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              Increase cooldown if a single gesture triggers twice; lower it for snappier control.
            </li>
